    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center max-w-4xl mx-auto">
          ...
          {/* Trust Badge */}
          <div className="inline-flex items-center gap-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-sm border border-gray-200 dark:border-gray-700">
      ...
      <section className="container mx-auto px-4 py-16 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <Card className="border-2 dark:border-gray-700 hover:shadow-lg transition-shadow dark:bg-gray-800">
            <CardHeader>
              <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/50 rounded-lg flex items-center justify-center mb-4">
                <Brain className="h-6 w-6 text-blue-600 dark:text-blue-400" />
              </div>
              <CardTitle className="dark:text-gray-100">Trắc nghiệm tính cách</CardTitle>
          ...
          <Card className="border-2 dark:border-gray-700 hover:shadow-lg transition-shadow dark:bg-gray-800">
            <CardHeader>
              ...
              <CardTitle className="dark:text-gray-100">Sàng lọc sức khỏe tinh thần</CardTitle>
              <CardDescription className="dark:text-gray-400">
          ...
          <Card className="border-2 dark:border-gray-700 hover:shadow-lg transition-shadow dark:bg-gray-800">
            <CardHeader>
              ...
              <CardTitle className="dark:text-gray-100">Theo dõi tiến trình</CardTitle>
              <CardDescription className="dark:text-gray-400">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto text-center">
          <div>
            ...
            <div className="text-gray-600 dark:text-gray-400">Bài test khoa học</div>
          </div>
          <div>
          ...
          <div>
            <div className="text-4xl font-bold text-pink-600 dark:text-pink-400 mb-2">5-15</div>
            <div className="text-gray-600 dark:text-gray-400">Phút mỗi test</div>
          </div>
          <div>
            <div className="text-4xl font-bold text-green-600 dark:text-green-400 mb-2">🔒</div>
            <div className="text-gray-600 dark:text-gray-400">Bảo mật tuyệt đối</div>
          </div>
        </div>
      </section>
      ...
      <footer className="container mx-auto px-4 py-8 text-center text-gray-600 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700">
        <p className="mb-2">
          <span className="font-semibold text-gray-800 dark:text-gray-200">Miso's Care</span> - Chăm sóc sức khỏe tinh thần của bạn
        </p>
        <p className="text-sm">
