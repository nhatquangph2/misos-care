    ...
    >
      <div className="container max-w-5xl mx-auto px-4">
        ...
        <Card className="glass-card shape-organic-2 mb-8 relative overflow-hidden">
          ...
          <div className={`blob-${result.severity.color === 'green' ? 'blue' : result.severity.color === 'yellow' ? 'yellow' : 'purple'} absolute -top-10 -right-10 opacity-30`} />
          ...
          <CardContent className="text-center relative z-10">
            ...
            <p className="text-sm font-medium text-muted-foreground mt-3">Thang điểm: 0-40</p>
          </CardContent>
        </Card>
